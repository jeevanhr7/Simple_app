...
<html lang="en">
<head>
    <title>Code coverage report for node-mongoskin/lib/collection.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">node-mongoskin/lib/collection.js</span></h1>
...
SkinCollection.prototype.bind = function(extendObject) {
  for(var key in extendObject) {
    <span class="missing-if-branch" title="else path not taken">E</span>if(typeof extendObject[key] == 'function') {
      this[key] = extendObject[key].bind(this);
    } else {
<span class="cstat-no" title="statement not covered">      this[key] = extendObject[key];</span>
    }
  }
}
&nbsp;
SkinCollection.prototype._open = function(callback) {
  ...
  this._skin_db.open(function(err, db) {
      <span class="missing-if-branch" title="if path not taken">I</span>if(err) <span class="cstat-no"
                                                                                      title="statement not covered">return callback(err);</span>
