...
<html lang="en">
<head>
    <title>Code coverage report for node-mongoskin/lib/utils.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">node-mongoskin/lib/utils.js</span></h1>

    <h2>
        Statements: <span class="metric">98.98% <small>(97 / 98)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Branches: <span class="metric">91.49% <small>(43 / 47)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Functions: <span class="metric">100% <small>(18 / 18)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Lines: <span class="metric">100% <small>(96 / 96)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">node-mongoskin/lib/</a>
        &#187; utils.js
    </div>
</div>
<div class="body">
<pre><table class="coverage">
    <tr>
        ...
        <td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
  ...
  function SkinClass() {
    ...
    this._init &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered">this._init();</span>
  }
...
&nbsp;
  function bindSkin(propName) {
    ...
    if(typeof fn == 'function') {
      ...
      <span class="missing-if-branch" title="else path not taken">E</span>if (desc.get) {
...
&nbsp;
  SkinClass._bindSetter = function(propName) {
      SkinClass.prototype.__defineSetter__(propName, function(value) {
          ...
          this.open(function(err, p_native) {
              <span class="missing-if-branch" title="if path not taken">I</span>if(err) <span class="cstat-no"
                                                                                              title="statement not covered">return onError(err, args, skinClassName + '.' + propName);</span>
...
&nbsp;
  SkinClass.prototype.close = function (callback) {
    ...
    } else <span class="missing-if-branch" title="else path not taken">E</span>if (this._state === STATE_OPENNING) {
      var self = this;
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Sep 14 2015
        15:12:40 GMT-0400 (EDT)
    </div>
</div>
