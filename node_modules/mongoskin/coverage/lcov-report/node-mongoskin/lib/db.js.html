...
<html lang="en">
<head>
    <title>Code coverage report for node-mongoskin/lib/db.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">node-mongoskin/lib/db.js</span></h1>
...
SkinDb.prototype._open = function(callback) {
  ...
  } else <span class="missing-if-branch" title="else path not taken">E</span>if(this._connect_args) {
